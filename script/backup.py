...
def showarray(a, fmt='jpeg' ,i=0):
    ...
    if len(count) > 3 and len(count)%4 == 0:
        s.save('/home/roboworks/deepdream/images/result{}.jpg'.format(len(count)/4))
        print('finish ')
    else:
        print('no_save')
...
img0 = PIL.Image.open('/home/roboworks/deepdream/images/roboworks.jpg')
...
render_deepdream(tf.square(T('conv2d0')), img0)
render_deepdream(tf.square(T('maxpool0')), img0)
render_deepdream(tf.square(T('localresponsenorm0')), img0)
render_deepdream(tf.square(T('conv2d1')), img0)
render_deepdream(tf.square(T('conv2d2')), img0)
render_deepdream(tf.square(T('localresponsenorm1')), img0)
render_deepdream(tf.square(T('maxpool1')), img0)
